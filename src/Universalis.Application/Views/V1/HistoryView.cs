...
public class HistoryView
{
    ...
    public IDictionary<int, int> StackSizeHistogram { get; init; } = new Dictionary<int, int>();
    ...
    public IDictionary<int, int> StackSizeHistogramNq { get; init; } = new Dictionary<int, int>();
    ...
    public IDictionary<int, int> StackSizeHistogramHq { get; init; } = new Dictionary<int, int>();
