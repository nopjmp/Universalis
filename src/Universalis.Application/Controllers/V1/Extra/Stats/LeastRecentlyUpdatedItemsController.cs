...
[ApiVersion("2")]
[Route("api")]
public class LeastRecentlyUpdatedItemsController : WorldDcRegionControllerBase
{
    ...
    [Route("extra/stats/least-recently-updated")]
    ...
    [MapToApiVersion("2")]
    [ApiTag("Least-recently updated items")]
    [Route("v{version:apiVersion}/extra/stats/least-recently-updated")]
    [ProducesResponseType(typeof(MostRecentlyUpdatedItemsView), 200)]
    [ProducesResponseType(404)]
